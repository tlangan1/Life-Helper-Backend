...
# I turned back on the executable bit to test the github action protecting against allowing non-executable shell scripts. If you want to run it, you will need to turn the executable bit back on. 
